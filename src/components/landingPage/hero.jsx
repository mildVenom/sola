...
function Hero() {
    ...
    const image = data.allFile.edges.find(edge => edge.node.relativePath.includes('img1.jpg'));
            ...
            <div className="inner-hero w-full h-full">
                <div className="mid-section px-16 md:px-30 gap-5 py-4 flex justify-center items-center flex-col lg:flex-row ">
                    ...
                    <div className="right-container flex-1 lg:w-1/4 flex justify-center items-center relative">
                        <Img fixed={image.node.childImageSharp.fixed} alt="people sitting together" className="hero-right border-4 border-orange-500 p-2 rounded-full" width={400} loading='eager' />
